...
REPLACEMENTS = {
    "LONG_WORK_HOURS": (
        "근로시간은 1일 8시간, 1주 40시간을 원칙으로 하며, 연장근로는 관계 법령이 정한 "
        "범위에서 근로자와의 합의에 따라 실시한다."
    ),
    "BREAK_DENIAL": (
        "회사는 근로시간이 4시간인 경우 30분 이상, 8시간인 경우 1시간 이상의 휴게시간을 "
        "근로시간 도중에 부여하며, 근로자는 이를 자유롭게 이용할 수 있다."
    ),
    "ARBITRARY_WAGE_DEDUCTION": (
        "회사는 임금을 근로자에게 전액 지급하며, 법령 또는 단체협약에 특별한 근거가 있는 "
        "경우를 제외하고 임의로 공제하지 않는다."
    ),
    "EXCESSIVE_PROBATION_REDUCTION": (
        "수습기간은 입사일로부터 3개월로 하며, 수습기간의 임금과 근로조건은 관계 법령이 "
        "정한 기준 이상으로 적용한다."
    ),
    "UNPAID_OVERTIME": (
        "회사는 실제 연장근로시간을 기록하고, 연장근로에 대해서는 통상임금과 관계 법령에 "
        "따라 산정한 가산수당을 별도로 지급한다."
    ),
    "UNPAID_PREMIUMS": (
        "연장·야간·휴일근로가 발생한 경우 회사는 실제 근로시간을 기준으로 관계 법령에 따른 "
        "가산수당을 산정하여 임금과 함께 지급한다."
    ),
    "ANNUAL_LEAVE_WAIVER": (
        "회사는 근로자에게 관계 법령에 따른 연차유급휴가를 부여하며, 그 사용과 미사용 휴가의 "
        "처리는 관계 법령에 따른다."
    ),
    "SEVERANCE_NONPAYMENT": (
        "퇴직급여는 월 임금과 별도로 산정하며, 지급 요건을 충족한 경우 회사는 관계 법령이 "
        "정한 기준과 기한에 따라 지급한다."
    ),
    "RESIGNATION_RESTRICTION": (
        "근로자는 관계 법령과 취업규칙에서 정한 절차에 따라 퇴직 의사를 통보할 수 있으며, "
        "회사는 정당한 사유 없이 퇴직을 제한하지 않는다."
    ),
    "EXCESSIVE_PENALTY": (
        "근로계약 불이행을 이유로 위약금 또는 손해배상액을 미리 정하지 않으며, 실제 손해가 "
        "발생한 경우 귀책사유, 인과관계 및 손해액을 관계 법령에 따라 개별적으로 판단한다."
    ),
    "DAMAGE_SHIFTING": (
        "근로자의 손해배상 책임은 고의 또는 과실, 손해 발생과의 인과관계 및 실제 손해액을 "
        "고려하여 관계 법령에 따라 개별적으로 판단한다."
    ),
    "DAMAGE_WAGE_DEDUCTION": (
        "손해배상 책임과 임금 지급은 별도로 처리하며, 회사는 법령 또는 단체협약에 특별한 "
        "근거가 없는 한 손해액을 임금에서 일방적으로 공제하지 않는다."
    ),
    "UNILATERAL_DISMISSAL": (
        "회사가 근로자를 해고하려는 경우 관계 법령에서 정한 정당한 사유와 절차를 준수하고, "
        "해고 사유와 해고 시기를 서면으로 통지한다."
    ),
    "CLAIM_WAIVER": (
        "근로자는 관계 법령에 따라 행정기관에 진정하거나 법원에 소송을 제기하는 등 권리구제 "
        "절차를 이용할 수 있으며, 회사는 이를 이유로 불리하게 처우하지 않는다."
    ),
}
